  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        call: "bg-success text-success-foreground hover:bg-success/90 shadow-glow",
        endCall: "bg-destructive text-destructive-foreground hover:bg-destructive/90 shadow-glow",
        control: "bg-muted/50 text-foreground hover:bg-muted border border-border/50 hover:border-primary/30",
        next: "gradient-primary text-primary-foreground hover:scale-105 shadow-glow pulse-glow",
      },
      size: {
        ...
        control: "h-12 w-12 rounded-full",
      },
    },
    defaultVariants: {
      variant: "default",
